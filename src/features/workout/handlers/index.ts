...
import { GetPersonalRecordsHandler } from './get-personal-records/get-personal-records.handler';

export const commandHandlers = [CreateWorkoutHandler];

export const queryHandlers = [GetWorkoutHistoryHandler, GetPersonalRecordsHandler];
